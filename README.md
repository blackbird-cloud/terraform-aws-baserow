...
| <a name="input_db_max_capacity"></a> [db\_max\_capacity](#input\_db\_max\_capacity) | Maximum ACU for Aurora Serverless v2 (if used) | `number` | `4` | no |
| <a name="input_db_min_capacity"></a> [db\_min\_capacity](#input\_db\_min\_capacity) | Minimum ACU for Aurora Serverless v2 (if used) | `number` | `0.5` | no |
| <a name="input_db_password"></a> [db\_password](#input\_db\_password) | Master DB password (provide via TF\_VAR\_db\_password) | `string` | `null` | no |
